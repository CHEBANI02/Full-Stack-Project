    ...
    <form onSubmit={handleSubmit}>
        ...
        {!isAdmin && isSignup && (
          ...
          <FormLabel sx={{labelStyle}}>Email</FormLabel>
            ...
            <Button variant='outlined' sx={{marginTop:2,borderRadius:10,bgcolor:"#2b2d42"}} type='submit' fullWidth>
                {isSignup?"Signup":"Login"}
            </Button>
            {!isAdmin && (
                <Button onClick={()=> setIsSignup(!isSignup)} sx={{marginTop:2,borderRadius:10}} fullWidth>
